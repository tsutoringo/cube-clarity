...
describe.each(
  [
    ...
    ["６Arrows", parseMoveNotation("D L' U R' B' R B U2 D B D' B' L U D'").unwrap()],
    ...
    ["６ Crosses", parseMoveNotation("R2 L' D F2 R' D' R' L U' D R D B2 R' U D2").unwrap()],
    ...
    ["６T", parseMoveNotation("F2 R2 U2 F' B D2 L2 F B").unwrap()],
    ["Corner Cross", parseMoveNotation("F B' U F U F U L B L2 B' U F' L U L' B").unwrap()],
    ["６U", parseMoveNotation("U' B2 U L2 D L2 R2 D' B' R D' L R' B2 U2 F' L' U'").unwrap()],
    ["Side Stripes", parseMoveNotation("F U F R L2 B D' R D2 L D' B R2 L F U F").unwrap()],
    ["３Cycle Edges", parseMoveNotation("U2 L U’ D F R2 L U D’ B’ D2 F2 L2 U’ F2 R2 B2 D F2 L2").unwrap()],
